...
// Button sub-class
public class AITypeButton: UIButton {
    var actionType = AIActionType.None
...
// Example: AIAlertView().showSuccess(self, title: "Test", subTitle: "Value").close()
public class AIAlertViewResponder {
    let alertview: AIAlertView

    // Initialisation and Title/Subtitle/Close functions
    public init(alertview: AIAlertView) {
...
// The Main Class
public class AIAlertView: UIViewController {
    ...
    public func addButton(title:String, action:()->Void)->AITypeButton {
        let btn = addButton(title)
        btn.actionType = AIActionType.Closure
        btn.action = action
    ...
    public func addButton(title:String, target:AnyObject, selector:Selector)->AITypeButton {
        let btn = addButton(title)
        btn.actionType = AIActionType.Selector
        btn.target = target
    ...
    private func addButton(title:String)->AITypeButton {
        // Update view height
        kWindowHeight += kButtonHeight
        // Add button
        let btn = AITypeButton()
    ...
    func buttonTapped(btn:AITypeButton) {
        if btn.actionType == AIActionType.Closure {
            btn.action()
        } else if btn.actionType == AIActionType.Selector {
            let ctrl = UIControl()
    ...
    func buttonTapDown(btn:AITypeButton) {
        var hue : CGFloat = 0
    ...
    func buttonRelease(btn:AITypeButton) {
    ...
    public func showSuccess(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0x22B573, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showError(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0xC1272D, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showNotice(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0x727375, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showWarning(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0xFFD110, colorTextButton: UInt=0x000000) -> AIAlertViewResponder {
    ...
    public func showInfo(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0x2866BF, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showWait(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt?=0xD62DA5, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showEdit(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt=0xA429FF, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showTitle(title: String, subTitle: String, style: AIAlertViewStyle, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0, colorStyle: UInt?, colorTextButton: UInt=0xFFFFFF) -> AIAlertViewResponder {
    ...
    public func showTitle(title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: AIAlertViewStyle, colorStyle: UInt?, colorTextButton: UInt?) -> AIAlertViewResponder {
        selfReference = self
        view.alpha = 0
        ...
        case .Success:
            ...
            iconImage = AIAlertViewStyleKit.imageOfCheckmark

        case .Error:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = AIAlertViewStyleKit.imageOfCross

        case .Notice:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = AIAlertViewStyleKit.imageOfNotice

        case .Warning:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = AIAlertViewStyleKit.imageOfWarning

        case .Info:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = AIAlertViewStyleKit.imageOfInfo

        case .Edit:
            viewColor = UIColorFromRGB(colorStyle!)
            iconImage = AIAlertViewStyleKit.imageOfEdit
        ...
        // Chainable objects
        return AIAlertViewResponder(alertview: self)
    }
...
class AIAlertViewStyleKit : NSObject {
...
//    }
    ...
    class var imageOfCheckmark: UIImage {
        ...
        AIAlertViewStyleKit.drawCheckmark()
    ...
    class var imageOfNotice: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), false, 0)
        AIAlertViewStyleKit.drawNotice()
    ...
    class var imageOfWarning: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), false, 0)
        AIAlertViewStyleKit.drawWarning()
